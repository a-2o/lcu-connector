    ...
    static getLCUPathFromProcess() {
        return new Promise(resolve => {
            ...
            const command = IS_WIN
                ? `PowerShell -Command "Get-CimInstance Win32_Process -Filter \\"Name='LeagueClientUx.exe'\\" | Select-Object -ExpandProperty CommandLine"`
                : IS_WSL
                    ? `powershell.exe -Command "Get-CimInstance Win32_Process -Filter \\"Name='LeagueClientUx.exe'\\" | Select-Object -ExpandProperty CommandLine"`
